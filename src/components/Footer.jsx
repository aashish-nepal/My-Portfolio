      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          >
            <h3 className="text-2xl font-bold mb-6 flex items-center">
              <span className="bg-indigo-600 text-white p-2 rounded-lg mr-3">AN</span>
              Aashish Nepal
            </h3>
            <p className="text-gray-400 mb-6">
              Crafting digital excellence through innovative web solutions and cutting-edge technologies.
            </p>
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#experience" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-1 h-1 bg-gray-400 rounded-full mr-2"></span>
                  Experience
                </Link>
              </li>
          ...
          >
            ...
            <address className="not-italic text-gray-400 space-y-3">
              <div className="flex items-start">
                ...
                <span>nepal.aashish00@gmail.com</span>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-indigo-400 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+977 9869100969</span>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-indigo-400 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <p className="text-gray-500">
            ...
            <span className="block sm:inline"> Crafted with <span className="text-indigo-400">Next.js</span> and <span className="text-indigo-400">Tailwind CSS</span>.</span>
          </p>
        </motion.div>
      </div>
    </footer>
