                  ...
                  <div className="space-y-6 md:space-y-8">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3">
                        {['Modular', 'Performant', 'Responsive', 'Secure', 'Scalable', 'Accessible'].map((principle) => (
                          ...
                          >
                            ...
                            <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">{principle}</span>
                          </motion.div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 sm:gap-4 pt-1 sm:pt-2">
                      <motion.button 
                        ...
                        whileTap={{ scale: 0.98 }}
                      >
                        <span className="relative z-10 font-medium flex items-center text-amber-50 text-sm sm:text-base">
            ...
            >
              ...
              <div className="relative mb-6 sm:mb-8 h-40 sm:h-48 w-full rounded-full overflow-hidden">
                ...
                {displayedSkills.slice(0, 6).map((skill, i) => {
                  ...
                  const radius = isClient ? 60 + (window.innerWidth >= 640 ? 20 : 0) : 60;
                  ...
                  return (
                    <motion.div
                      ...
                      className={`absolute w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white dark:bg-gray-800 shadow-sm sm:shadow-md flex items-center justify-center text-lg sm:text-xl cursor-pointer z-10 ${
                        hoveredSkill === skill.name ? 'scale-110 sm:scale-125 shadow-md sm:shadow-lg' : ''
                      }`}
                      style={{
                        left: `${x}px`,
                        top: `${y}px`,
                      ...
                      whileHover={{ scale: isClient && window.innerWidth >= 640 ? 1.2 : 1.1 }}
